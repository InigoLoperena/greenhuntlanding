...
serve(async (req) => {
  ...
  try {
    ...
    try {
      ...
      const errorMsg = `Stripe connection failed: ${error instanceof Error ? error.message : 'Unknown error'}`;
    ...
    try {
      ...
      const errorMsg = `Supabase connection failed: ${error instanceof Error ? error.message : 'Unknown error'}`;
      testResults.errors.push(errorMsg);
      logStep("ERROR", errorMsg);
    }
    ...
    try {
      ...
      const errorMsg = `Customer creation test failed: ${error instanceof Error ? error.message : 'Unknown error'}`;
      testResults.errors.push(errorMsg);
      logStep("ERROR", errorMsg);
    }
    ...
    try {
      ...
      const errorMsg = `Subscription creation test failed: ${error instanceof Error ? error.message : 'Unknown error'}`;
      testResults.errors.push(errorMsg);
      logStep("ERROR", errorMsg);
    }
    ...
    try {
      ...
      const errorMsg = `Payment intent creation test failed: ${error instanceof Error ? error.message : 'Unknown error'}`;
      testResults.errors.push(errorMsg);
      logStep("ERROR", errorMsg);
    }
    ...
    try {
      ...
      const errorMsg = `Wallet functionality test failed: ${error instanceof Error ? error.message : 'Unknown error'}`;
      testResults.errors.push(errorMsg);
      logStep("ERROR", errorMsg);
    }
    ...
    try {
      ...
      const errorMsg = `Affiliate system test failed: ${error instanceof Error ? error.message : 'Unknown error'}`;
      testResults.errors.push(errorMsg);
      logStep("ERROR", errorMsg);
    }
