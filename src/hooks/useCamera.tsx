...
export const useCamera = (): {
  ...
  // Web camera capture function using native browser APIs with flash support
          ...
          if (mediaStream) {
            ...
            if (capabilities.torch) {
              ...
              try {
                ...
                flashBtn.style.background = flashEnabled ? '#f59e0b' : '#6b7280';
              } catch (error) {
                console.error('Error toggling flash:', error);
                flashBtn.style.display = 'none';
              }
            } else {
              // Flash not supported, hide button
              flashBtn.style.display = 'none';
            }
          }
        };
    ...
    try {
      ...
      if (isNative) {
        ...
        try {
          ...
          // Capture photo with flash support (if available)
          ...
          photo = await Camera.getPhoto({
            ...
            width: 1024,
            height: 1024,
            // Note: Flash control in Capacitor Camera plugin is limited
            // Advanced camera features may require additional plugins
          });
