...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'landing.tutorial.step1': 'Take photos of valuable discarded street finds and Make money when someone nearby unlocks the coordinates.',
  ...
  es: {
    ...
    'landing.tutorial.step1': 'Toma fotos de hallazgos valiosos en la calle y Gana dinero cuando alguien cercano desbloquea las coordenadas.',
