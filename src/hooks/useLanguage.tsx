...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'landing.ambassador.description': 'Help us build our antique-thrift store, junk removers, waste managers and influencers network. Earn money by bringing partners on board and become a lifetime GreenHunt Ambassador to receive exclusive benefits such as higher commissions affiliate program and more',
    ...
    'landing.tutorial.disclaimer': '*It is not guaranteed that the object is still there, but the time of publication or the publisher user\'s reputation are indicators of the probability. We are integrating other systems to make sure publications are legit.',
  ...
  es: {
    ...
    'landing.ambassador.description': 'Ayúdanos a construir nuestra red de tiendas de antigüedades-segunda mano, servicios de recogida de trastos, gestores de residuos e influencers. Gana dinero trayendo socios y conviértete en Embajador de GreenHunt de por vida para recibir beneficios exclusivos como comisiones más altas en el programa de afiliados y más',
    ...
    'landing.tutorial.disclaimer': '*No está garantizado que el objeto siga ahí, pero el tiempo de publicación o la reputación del usuario que publica son indicadores de probabilidad. Estamos integrando otros sistemas para asegurar que las publicaciones sean legítimas.',
