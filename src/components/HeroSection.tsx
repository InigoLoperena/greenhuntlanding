    ...
    <>
      <section className="relative w-full min-h-screen bg-black flex items-center justify-center overflow-hidden py-12 px-4">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          {/* Title */}
          <h1 className="font-permanent-marker text-2xl md:text-3xl lg:text-4xl xl:text-5xl leading-tight mb-8 text-center max-w-4xl mx-auto"
              style={{ color: '#b5ef77' }}>
          ...
          {/* Stickers - positioned outside content area */}
          <div className="absolute top-24 left-4 md:left-8 lg:left-16 transform -rotate-6 z-20">
            <img 
              src={stickerStooping} 
              alt="Notice: Stooping Not Allowed" 
              className="w-16 md:w-20 lg:w-24 h-auto shadow-lg"
            />
          </div>

          <div className="absolute bottom-8 right-4 md:right-8 lg:right-16 transform rotate-6 z-20">
            <img 
              src={stickerRecycle} 
              alt="Recycle" 
              className="w-14 md:w-18 lg:w-20 h-auto shadow-lg"
            />
          </div>
        </div>
      </section>
