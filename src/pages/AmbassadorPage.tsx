                ...
                <div className="flex flex-col gap-2 bg-black/80 p-4 rounded-lg border border-primary/20">
                  ...
                  <form onSubmit={isLogin ? handleLogin : handleSignUp} className="space-y-2 w-56">
                    ...
                    <Button 
                      ...
                      disabled={loading} 
                      size="sm"
                      className="w-full bg-accent hover:bg-accent/90 font-permanent-marker text-sm h-9 btn-purple-text"
                    >
          ...
          {user && profile && <>
              ...
              <div className="mb-8 flex gap-4">
                {!showForm && !showProfile && (
                  <>
                    <Button onClick={() => setShowForm(true)} className="bg-accent hover:bg-accent/90 font-permanent-marker text-lg px-8 py-4 btn-purple-text">
                  ...
                  <CardContent>
                    <form onSubmit={handleSaveProfile} className="space-y-6">
                      ...
                      <Button 
                        type="submit" 
                        disabled={loading}
                        className="w-full bg-accent hover:bg-accent/90 font-permanent-marker btn-purple-text"
                      >
                        {loading 
