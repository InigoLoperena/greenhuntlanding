        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div className="flex flex-col items-center text-center">
              <div className="mb-6">
                <img alt="Take photos of street finds" className="w-full max-w-xs rounded-2xl shadow-lg" loading="lazy" src="/lovable-uploads/d90e4e57-729b-469b-8a06-f989d61ae441.png" />
              </div>
