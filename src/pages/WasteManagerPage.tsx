  ...
  return <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      backgroundImage: 'url(/lovable-uploads/brick-wall-background.png)'
        ...
        <div className="container mx-auto max-w-6xl flex justify-between items-center">
          ...
          <Link to="/">
            <Button className="bg-accent hover:bg-accent/90 font-permanent-marker btn-purple-text">
              Back to Home
            </Button>
          </Link>
        </div>
      ...
      backgroundImage: 'url(/lovable-uploads/brick-wall-background.png)'
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              <img src={wasteScoutMotorcycle} alt="Motorcycle scout finding valuable items with truck following" className="w-full h-auto rounded-lg shadow-2xl" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
      ...
      backgroundImage: 'url(/lovable-uploads/brick-wall-dark.png)'
        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          ...
          <Link to="/#waitlist">
            <Button className="bg-accent hover:bg-accent/90 font-permanent-marker text-xl px-12 py-6 btn-purple-text">
              Get Beta
            </Button>
          </Link>
        </div>
